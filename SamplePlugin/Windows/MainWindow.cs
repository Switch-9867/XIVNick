...
public class MainWindow : Window, IDisposable
{
    ...
    public MainWindow(NicknamePlugin plugin, string goatImagePath)
    ...
    public override void Draw()
    {
        ...
        using (var child = ImRaii.Child("SomeChildWithAScrollbar", Vector2.Zero, true))
        {
            ...
            if (child.Success)
            {
                ...
                var goatImage = DalamudStatic.TextureProvider.GetFromFile(GoatImagePath).GetWrapOrDefault();
                if (goatImage != null)
                {
                ...
                var localPlayer = DalamudStatic.ClientState.LocalPlayer;
                if (localPlayer == null)
                {
                ...
                var territoryId = DalamudStatic.ClientState.TerritoryType;
                if (DalamudStatic.DataManager.GetExcelSheet<TerritoryType>().TryGetRow(territoryId, out var territoryRow))
                {
